...
namespace Application.Tests.CollaboratorServiceTests
{
    ...
    {
        [Fact]
        public async Task WhenUserHasMatchingSurnames_ThenReturnsTrue()
        {
            //arrange
            ...
            //act
            var result = await collaboratorService.HasSurnames(It.IsAny<long>(), It.IsAny<string>());
        ...
        [Fact]
        public async Task WhenUserDoesNotHaveMatchingSurnames_ThenReturnsFalse()
        {
            //arrange
            Mock<ICollaborator> collaboratorDouble = new Mock<ICollaborator>();
            collaboratorDouble.Setup(c => c.GetUserId()).Returns(It.IsAny<long>());
