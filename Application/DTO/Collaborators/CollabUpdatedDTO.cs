...
namespace Application.DTO.Collaborators
{
    ...
    {
        public CollabUpdatedDTO(Guid collabId, Guid userId, string names, string surnames, string email, PeriodDateTime userPeriod, PeriodDateTime collaboratorPeriod)
        {
            CollabId = collabId;
            UserId = userId;
            Names = names;
