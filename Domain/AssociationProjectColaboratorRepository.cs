...
public class AssociationProjectColaboratorRepository : IAssociationProjectColaboratorRepository
{
    ...
    public AssociationProjectColaboratorRepository(
        List<IAssociationProjectColaborator> associationsProjectColaborator
    )
    {
    ...
    {
        return _associationsProjectColaborator
            .Where(a => a.HasProject(project) && a.AssociationIntersectDates(InitDate, FinalDate))
            .Select(a => a.GetColaborator());
    }
}
